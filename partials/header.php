        ...
        <div class="row">
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <!-- ***** Menu Start ***** -->
                    <ul class="nav">
                      <li ><a href="index.php#top" class="<?php if($page =='deals'){echo 'active';}?>">Home</a></li>
                      <li ><a href="index.php#services" class="<?php if($page =='deals'){echo 'active';}?>">Services</a></li>
                      <li ><a href="index.php#projects" class="<?php if($page =='deals'){echo 'active';}?>">Projects</a></li>
                      <li class="has-sub">
